...
order by g.tarih ASC";
    ...
    public function genel_uye_paroru_xls() {
        $sql = "select q.uye,q.eposta, q.seviye, q.cinsiyet,
        --strftime('%d/%m/%Y',q.dogum_tarihi) AS dogum_tarihi,
        q.dogum_tarihi AS dogum_tarihi,
        q.ekf_no,q.uc_ayi_icinde_devam_sayisi,q.uc_aylik_devam_yuzdesi,
